...
return(
  ...
  <div className="container-fluid">
    ...
    <Collapse isOpen={isOpen} navbar>
        ...
        <Link className="nav-link" aria-current="page" to="/criarcarro">Cadastre seu carro</Link>
            ...
            <UncontrolledDropdown nav inNavbar>
              ...
              <DropdownMenu>
                ...
                <DropdownItem><Link className="nav-link" aria-current="page" to="/atualizarcliente">Edite seus dados</Link></DropdownItem>
      ...
      <Nav navbar>
        <li className="nav-item">
        <Link className="nav-link" aria-current="page" to="/clientes"><FaPersonCirclePlus className="fa-cadastro"/> Cadastre-se</Link>
        </li>
        <li className="nav-item">
