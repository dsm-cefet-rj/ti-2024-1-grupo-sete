      ...
      <Accordion open={open} toggle={toggle}>
        <AccordionItem>
          ...
          <AccordionBody accordionId="1">
            <h4>Somos uma empresa que tem o objetivo de facilitar a mediação entre um locador e um locatário de carros. [completar]</h4>
          </AccordionBody>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionBody accordionId="2">
            <h4>Será necessário criar uma conta e no cadastro pediremos seus dados (RG, CPF, Carteira de motorista e pontuação). Após uma breve análise dos 
                seus dados, você já poderá aproveitar dos nossos serviços. [completar] 
            </h4>
          </AccordionBody>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionBody accordionId="3">
            <h4>Depois de criar sua conta neste site, no seu perfil você poderá acionar a função "Alugar meu Carro". Você terá que preencher um formulário e submeter fotos em boa qualidade do seu carro, documentos seus e do carro e 
                todos as características e acessórios que seu carro possui. Depois de submetido, passará por uma análise, e caso seja aprovado, imediatamente aparecerá em nosso catálogo. [completar]</h4>
          </AccordionBody>
        </AccordionItem>
      </Accordion>
    </div>
